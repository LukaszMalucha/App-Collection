...
new Vue({
  ...
  methods: {
    processData() {
          const url = "http://3.249.1.158:8000/sommeliers/summary";
    ...
    classifierBuild() {
          ...
          const url = "http://3.249.1.158:8000/sommeliers/build";
          axios.get(url).then(response => {
            if (response.data) {
    ...
    classifierFit() {
          ...
          document.getElementById("page-index-sommeliers").style.display = "none";
          const url = "http://3.249.1.158:8000/sommeliers/fit";
          axios.get(url).then(response => {
            if (response.data) {
    ...
    rateWine() {
        ...
        const url = "http://3.249.1.158:8000/sommeliers/rate";
