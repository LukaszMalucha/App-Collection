...
$(document).ready(function() {
    ...
    $('.blockMining').on('click', function(){
        $.ajax({
                    type : 'POST',
                    url : 'http://54.194.63.163:8000/blockchain/'
        })
        .done(function(data) {
    ...
    $('.validationCheck').on('click', function(){
        $.ajax({
                    type : 'GET',
                    url : 'http://54.194.63.163:8000/blockchain/validation-check'
        })
        .done(function(data) {
            if (data.error) {
    ...
    $('.resetChain').on('click', function(){
        $.ajax({
                    type : 'POST',
                    url : 'http://54.194.63.163:8000/blockchain/reset'
        })
        .done(function(data) {
            if (data.error) {
                $('#messageError').text(data.message + '. Current length: ' + data.length).show().fadeOut(3000);
    ...
    $('#formTransaction').on('submit', function(event){
        $.ajax({
                ...
                type : 'POST',
                url : 'http://54.194.63.163:8000/blockchain/transaction'
